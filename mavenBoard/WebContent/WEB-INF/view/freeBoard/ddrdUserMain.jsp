...
<body>
	...
	<div style="float: left;"></div><input type="text" class="form-control" style="float: left; width:200px;" name="I_NAME" id="I_NAME" placeholder="이름">
	<div style="float: left;"></div><input type="text" class="form-control" style="float: left; width:200px;" name="I_AGE" id="I_AGE" placeholder="나이">
	<div style="float: left;"></div><input type="text" class="form-control" style="float: left; width:200px;" name="I_SEX" id="I_SEX" placeholder="성별">
	<div style="float: left;"></div><input type="text" class="form-control" style="float: left; width:200px;" name="I_JOIN_DATE" id="I_JOIN_DATE" placeholder="가입일">
	...
	<!--  <button id="search"><span class="glyphicon glyphicon-search" aria-hidden="true"></button>
	<form action="./search.do">
		<input type="text" class="form-control" style="width:200px;" name="searchWord" id="searchWord" placeholder="이름을 검색하세요">
	</form> -->
	...
	<table class="table" id="table" border="0" cellspacing="0" cellpadding="0">
		...
		<c:forEach var="userList" items="${map.UserList }">
			<tr>
				<td style="width:50px"><input type="checkbox" name="checkbox" id="checkbox"><input type="hidden" name="FLAG" id="FLAG" value="L"></td>
				<td style="width:80px">${userList.USER_NUMBER }<input type="hidden" name="USER_NUMBER" id="USER_NUMBER" value="${userList.USER_NUMBER }"></td>
				<td style="width:100px">${userList.NAME }<input type="hidden" name="NAME" id="NAME" value="${userList.NAME }"></td>
				<td style="width:50px">${userList.SEX }<input type="hidden" name="SEX" id="SEX" value="${userList.SEX }"></td>
				<td style="width:50px">${userList.AGE }<input type="hidden" name="AGE" id="AGE" value="${userList.AGE }"></td>
				<td style="width:150px">${userList.JOIN_DATE }<input type="hidden" name="JOIN_DATE" id="JOIN_DATE" value="${userList.JOIN_DATE }"></td>
				<td style="width:80px">${userList.ATTENDING_COUNT }<input type="hidden" name="ATTENDING_COUNT" id="ATTENDING_COUNT" value="${userList.ATTENDING_COUNT }"></td>
				<td style="width:70px">${userList.ATTENDANCE_RATE }<input type="hidden" name="ATTENDANCE_RATE" id="ATTENDANCE_RATE" value="${userList.ATTENDANCE_RATE }"></td>
			</tr>
		</c:forEach>
